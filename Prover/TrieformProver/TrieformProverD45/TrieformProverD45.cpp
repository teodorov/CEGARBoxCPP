...
Cache TrieformProverD45::persistentCache = Cache("P");
...
shared_ptr<Bitset>
TrieformProverD45::convertAssumptionsToBitset(literal_set literals) {
...
void TrieformProverD45::updateSolutionMemo(
...
bool TrieformProverD45::isInHistory(vector<shared_ptr<Bitset>> history,
                                    shared_ptr<Bitset> bitset) {
...
void TrieformProverD45::makePersistence() {
...
void TrieformProverD45::propagateLevels() {
  for (auto modalSubtrie : subtrieMap) {
...
void TrieformProverD45::propagateEuclideaness() {
...
void TrieformProverD45::prepareSAT(name_set extra) {
...
Solution TrieformProverD45::prove(vector<shared_ptr<Bitset>> history,
...
Solution TrieformProverD45::prove(literal_set assumptions) {
