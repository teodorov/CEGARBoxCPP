#ifndef TRIEFORM_PROVER_D45_HELPER_H
#define TRIEFORM_PROVER_D45_HELPER_H
...
#include "../TrieformProverD45/TrieformProverD45.h"
#include <memory>
#include <string>
...
class TrieformProverD45Helper : public Trieform {
private:
  int s5Modality = 0;
